...
const BrandLayout = () => {
  ...
  return (
    <Layout className="min-h-screen font-sans brand-layout-bg">
      <Sider
        collapsible
        collapsed={collapsed}
        ...
        theme="dark"
      >
        <div className="h-16 flex items-center justify-center m-4 rounded-lg brand-logo-container overflow-hidden">
          <h1
      ...
      <Layout>
        <Header className="px-6 flex justify-between items-center brand-header">
        ...
        <Content className="m-6 p-6 brand-content min-h-[280px]">
          <Outlet />
        </Content>
      </Layout>
    </Layout>
